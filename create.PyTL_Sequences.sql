...
------------------------------------------------------------------------------------------------------------------------
    V_TABLE_NAME            USER_TABLES.TABLE_NAME%type := 'PyTL_Sequences';
...
------------------------------------------------------------------------------------------------------------------------
    ...
    --              COLUMN_NAME         DATA_TYPE       DATA_CHAR_LENGTH    CHAR_USED   DATA_DEFAULT                                    OLD_COLUMN_NAMES
       ...
       ,T_FIELD_NAME('SEQUENCE_NAME'    ,'VARCHAR2'     ,256                ,'C'        ,''                                             ,'')
       ,T_FIELD_NAME('SEQUENCE_VALUE'   ,'NUMBER'       ,22                 ,''         ,''                                             ,'')
    );
------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------
    type T_CONSTRAINT       is record (
        CONSTRAINT_NAME     varchar2(128 char)
       ,CONSTRAINT_ACTION   varchar2(128 char)
       ,CONSTRAINT_CONDTN   varchar2(128 char)
       ,CONSTRAINT_REFCES   varchar2(128 char)
...
------------------------------------------------------------------------------------------------------------------------
    type T_INDEX            is record (
        INDEX_NAME          varchar2(128 char)
       ,INDEX_UNIQUE        varchar2(128 char)
       ,INDEX_FIELDS        varchar2(128 char)
    ); type T_INDEXES       is table of T_INDEX;
    V_INDEXES               T_INDEXES := T_INDEXES(
    --              INDEX_NAME                          INDEX_UNIQUE        INDEX_FIELDS
        T_INDEX     ('SEQUENCE_NAME'                    ,'UNIQUE'           ,'SEQUENCE_NAME')
...
------------------------------------------------------------------------------------------------------------------------
    ...
    type T_TRIGGER          is record (
        COLUMN_NAME         varchar2(128 char)
       ,TRIGGER_TYPE1       varchar2(128 char)
       ,TRIGGER_TYPE2       varchar2(128 char)
       ,TRIGGER_BODY        varchar2(128 char)
...
------------------------------------------------------------------------------------------------------------------------
    ...
    V_FOUND_OBJECT_NAME     varchar2(128);
begin
